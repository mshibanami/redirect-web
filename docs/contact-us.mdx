...
- **Feedback Form**: You can send us feedback through the feedback form in the Redirect Web app. This will send an email directly to the developer, so your feedback is kept private from other users.

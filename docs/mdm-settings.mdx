...
RedirectWeb supports Apple's Managed App Configuration, allowing you (IT administrators) to deploy and manage app settings centrally across employee/student devices via a Mobile Device Management (MDM) solution.
...
Each rule object has the same format as the one you can [share/export via the app](export-or-import-rules), but you need to convert it from JSON to XML, like this:

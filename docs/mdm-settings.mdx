...
| `fallback`             | [Fallback object](#fallback-object) | Specify this when the configurations exceed the MDM payload limits. The app will fetch JSON/XML from this URL to apply the configuration.                                                                                                                                     |

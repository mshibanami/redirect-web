...
In the video, I used ManageEngine's MDM to deploy the configuration, but the same configuration can be used for other MDM solutions as long as they support Apple's Managed App Configuration.

...
The **Redirect From** option allows you to specify a URL pattern of web pages you want to redirect from. You can choose either [Wildcard](#wildcard) or [Regular Expression](#regular-expression).

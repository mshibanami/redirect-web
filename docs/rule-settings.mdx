...
This page provides detailed information of each setting in the *Edit Rule* screen in the Redirect Web app.
...
* There are 2 types of browsers you can choose:
    ...
    * **User specified browsers**: By tapping the Add button on the popover, you can select any browser other than Safari or Safari Technology Preview that has the Redirect Web extension installed.
* The **All except selected** checkbox lets you target every browser except the ones you’ve chosen.

> [!WARNING]
> Redirect Web can't differentiate whether the browser is **Safari** or **Safari Technology Preview** because the app checks the parent process of the extension to detect it but these two browsers share the same parent process (`/sbin/launchd`).
...
Redirect Web is powered by [Apple's Regex engine](https://developer.apple.com/documentation/foundation/nsregularexpression#1661042).

...
* There are 2 types of browsers you can choose:
    * **Browsers you can choose by default**: You can choose Safari, Chrome, Firefox, Edge, Opera, Orion, Arc, Brave, and Vivaldi by default. This doesn't differentiate variants of the same browser, such as Safari and Safari Technology Preview.

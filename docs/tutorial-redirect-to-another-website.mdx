...
Suppose you're addicted to Twitter, and you decide to meditate using [Unrush](https://unrush.org) whenever you accidentally open Twitter. Let's create a rule for that!

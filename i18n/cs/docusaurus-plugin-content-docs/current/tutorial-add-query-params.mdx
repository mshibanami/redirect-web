...
> [!NOTE]
> RegExr zobrazuje chybu, když neescapujete `/` pomocí `\`. Ačkoli to můžete escapovat, není to vyžadováno, protože Redirect Web používá jiný engine od Apple, který escapování nevyžaduje.

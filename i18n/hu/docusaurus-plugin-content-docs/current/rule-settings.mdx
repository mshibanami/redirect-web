...
Az **Átirányítás innen** opció lehetővé teszi, hogy megadja azoknak a weboldalaknak az URL-mintáját, amelyekről átirányítani szeretne. Választhat [Helyettesítő karakter](#wildcard) vagy [Reguláris kifejezés](#regular-expression) közül.

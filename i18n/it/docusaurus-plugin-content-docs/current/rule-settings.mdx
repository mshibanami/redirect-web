...
* Ci sono 2 tipi di browser che puoi scegliere:
    ...
    * **Browser specificati dall'utente**: Toccando il pulsante Aggiungi sul popover, puoi selezionare qualsiasi browser diverso da Safari o Safari Technology Preview che abbia l'estensione RedirectWeb installata.
...
> [!NOTE]
> Sebbene la sostituzione sia una funzionalità dell'Espressione regolare, puoi usarla anche per Carattere jolly perché RedirectWeb converte internamente Carattere jolly in Espressione regolare.
...
RedirectWeb è alimentato dal [motore Regex di Apple](https://developer.apple.com/documentation/foundation/nsregularexpression#1661042).

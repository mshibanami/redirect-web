...
L'opzione **Reindirizza da** ti consente di specificare un pattern URL di pagine web da cui desideri reindirizzare. Puoi scegliere tra [Carattere jolly](#wildcard) o [Espressione regolare](#regular-expression).

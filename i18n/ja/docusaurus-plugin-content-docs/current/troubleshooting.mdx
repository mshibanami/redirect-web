...
- **ブラウザ拡張がインストールされ、該当ページで有効になっているか:** RedirectWeb のブラウザ拡張をインストールし、リダイレクト元のウェブページで拡張が有効になっていることを確認してください。ソースのウェブページで拡張のポップアップをこのように開ける場合は、拡張は正しくインストールされています:
    <Image src={ExtensionPopup} alt="RedirectWeb 拡張のポップアップ" width="260" hasShadow/>
...
<Image src={ErrorOverlay} alt="RedirectWeb のエラーオーバーレイ" width="260" hasShadow hasRoundedCorners/>

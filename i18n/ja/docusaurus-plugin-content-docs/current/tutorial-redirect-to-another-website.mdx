...
Twitter中毒で、その習慣を断ち切るために、誤ってTwitterを開いてしまったときはいつでも[Unrush](https://unrush.org)にアクセスしてモチベーションを高める名言を読んだり短い瞑想をしたりすることにしたとします。そのためのルールを作成しましょう！
...
これで、TwitterにアクセスするとRedirectWebが瞑想に連れて行ってくれます！

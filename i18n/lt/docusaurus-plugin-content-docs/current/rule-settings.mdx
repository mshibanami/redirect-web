...
Šiame puslapyje pateikiama išsami informacija apie kiekvieną nustatymą „Redirect Web“ programos ekrane *Redaguoti taisyklę*.
...
> [!NOTE]
> Nors pakeitimas yra reguliariosios išraiškos funkcija, galite jį naudoti ir pakaitos simboliui, nes „Redirect Web“ viduje pakaitos simbolį konvertuoja į reguliariąją išraišką.
...
„Redirect Web“ veikia naudojant [Apple Regex variklį](https://developer.apple.com/documentation/foundation/nsregularexpression#1661042).

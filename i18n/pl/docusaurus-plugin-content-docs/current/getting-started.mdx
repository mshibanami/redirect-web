...
> [!NOTE]
> RegExr pokazuje błąd, gdy nie ominięto znaczenia `/` za pomocą `\`. Chociaż można to omieniąć, nie jest to wymagane, ponieważ Redirect Web używa innego silnika firmy Apple, który nie wymaga omijania znaczenia.

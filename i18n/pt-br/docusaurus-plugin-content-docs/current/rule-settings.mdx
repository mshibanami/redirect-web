...
A opção **Redirecionar De** permite que você especifique um padrão de URL de páginas da web das quais você deseja redirecionar. Você pode escolher entre [Curinga](#wildcard) ou [Expressão Regular](#regular-expression).

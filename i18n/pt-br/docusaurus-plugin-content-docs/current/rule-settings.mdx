...
O padrão é `main_frame`, que é a página de nível superior carregada em uma aba.
...
e corresponder a `https://google.com/hello`, então a URL de destino será `https://apple.com/hello`.

Além disso, você pode modificar os textos de `$1`, `$2`, ... antes de fazer as substituições. Verifique a seção [Processamento de Grupo de Captura](#capturing-group-processing) para os detalhes.
...
>
> * Figma: `figma://file/Seu_ID_Figma`
> * Firefox: `firefox://open-url?url=https://example.com/hello`
> * Google Chrome: `googlechromes://example.com`
> * Microsoft Edge: `microsoft-edge://example.com`
> * Notion: `notion://www.notion.so/Seu_ID_da_Nota`
> * Slack: `slack://open`
...
**Expressão Regular** (Regex) é uma ferramenta poderosa para corresponder padrões em texto, alimentada pelo mecanismo de expressão regular da Apple, que é descrito [aqui](https://developer.apple.com/documentation/foundation/nsregularexpression#1661042). Ele permite que você defina um padrão específico que corresponde a um conjunto de strings. Aqui estão alguns exemplos.

...
Opțiunea **Redirecționare de la** vă permite să specificați un model URL al paginilor web de la care doriți să redirecționați. Puteți alege fie [Joker](#wildcard), fie [Expresie regulată](#regular-expression).
...
> [!NOTE]
> Deși substituția este o funcționalitate a expresiilor regulate, o puteți utiliza și pentru Joker, deoarece Redirect Web convertește intern Joker în expresie regulată.
...
Redirect Web este alimentat de [motorul Regex de la Apple](https://developer.apple.com/documentation/foundation/nsregularexpression#1661042).

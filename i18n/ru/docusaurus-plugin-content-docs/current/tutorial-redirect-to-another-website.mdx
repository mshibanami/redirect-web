...
Вы можете проверить, как работает правило, добавив пример URL-адреса в раздел *Примеры* на экране *Редактировать правило*. Например, если вы введете `https://x.com/UN`, он покажет `https://insighttimer.com/saraauster/guided-meditations/calm` в качестве результата.

...
> [!NOTE]
> RegExr prikaže napako, ko ne pobegnete `/` z `\`. Čeprav ga lahko pobegnete, to ni potrebno, saj Redirect Web uporablja drug motor podjetja Apple, ki ne zahteva pobega.

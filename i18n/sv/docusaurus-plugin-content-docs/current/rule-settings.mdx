...
> [!WARNING]
> Redirect Web kan inte skilja om webbläsaren är **Safari** eller **Safari Technology Preview** eftersom appen kontrollerar tilläggets överordnade process för att upptäcka det, men dessa två webbläsare delar samma överordnade process (`/sbin/launchd`).

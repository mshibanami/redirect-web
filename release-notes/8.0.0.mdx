...
Meanwhile, it is still listed as “Redirect Web for Safari” on the App Store for non-Mac devices. This reflects the fact that the iOS version supports only Safari, and the “for Safari” part simply indicates the supported platform, not the app’s brand name.

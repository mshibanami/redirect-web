...
Since we started supporting many browsers, we changed the app’s brand name to **Redirect Web** from Redirect Web for Safari, and we also updated our [Terms of Use](/docs/terms-of-use) and [Privacy Policy](/docs/privacy-policy) to reflect the renaming. Find the full diff [here](https://github.com/mshibanami/redirect-web/commit/417f0571b3300e8c9c842a6b82cfb224a625d5ff).

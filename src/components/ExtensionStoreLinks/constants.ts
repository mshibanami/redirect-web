...
}): ExtensionStoreDetails {
  switch (browserName) {
    case BrowserName.Chrome:
      return {
        storeName: 'Chrome Web Store',
        extensionPageUrl:
          'https://chromewebstore.google.com/detail/ffglckbhfbfmdkefdmjbhpnffkcmlhdh',
    ...
    case BrowserName.Edge:
      return {
        ...
        extensionPageUrl:
          'https://microsoftedge.microsoft.com/addons/detail/hmfkakfdccgdpgemaicfgngnmflefpga',

...
export default function ReleaseNotesListHeader({ blogTitle }: { blogTitle: string }): ReactNode {
  return (
    <header className="margin-bottom--lg">
      ...
      <p>
        <Translate
          ...
          values={{
            appStoreName: <Link href="https://apps.apple.com/app/id1571283503">App Store</Link>,
          }}
        >
          {

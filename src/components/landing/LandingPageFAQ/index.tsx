...
const faqItems: FAQItem[] = [
  {
    ...
    answer: (
      <div>
        <p>
          <Translate id="landingPageFAQ.otherApps.answer" description="FAQ answer about other apps">
            {
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        >
          We recommend the one-time purchase, as the price difference is small. The main reason we
          offer the subscription is to allow you to try all the features through its free trial.
        </Translate>
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        ...
        >
          Yes. You need to download the RedirectWeb app from the App Store regardless of which
          browser you use. The app is required to manage your rules.
        </Translate>
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        ...
        >
          No, it's always free and open source. You can find the source of all the contents on
          GitHub.
        </Translate>{' '}
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        >
          Not at this time. Currently, RedirectWeb only works on Mac, iPhone, iPad, and Apple Vision
          Pro.
        </Translate>
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        <Translate id="landingPageFAQ.ads.answer" description="FAQ answer about ads and tracking">
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        >
          100% no. Browser extensions have deep control over your browsing and data. RedirectWeb
          will always remain in our hands, so you can browse with complete confidence.
        </Translate>
      </p>
    ),
  },
  ...
  return (
    <div className={styles.faqSection}>
      <div className={styles.faqHeader}>
        <Heading as="h2">
          <Translate id="landingPageFAQ.title" description="FAQ section title">

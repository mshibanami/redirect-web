...
const useCases = [
  {
    title: translate({
      ...
      description:
        "Use case title for a redirection rules of changing browser's default search engine to another search engine",
    }),
    description: translate({
      ...
      description:
        "Use case description for a redirection rules of changing browser's default search engine to another search engine",
    }),
  },
  {
    title: translate({
    ...
    description: translate({
      ...
      description:
        'Use case description for a redirection rules of viewing Reddit in its classic design',
    }),
  },
  {
    title: translate({
      ...
      description:
        'Use case title for a redirection rules of opening Apple Maps from Google Maps links',
    }),
    description: translate({
      id: 'productUseCases.openAppleMaps.description',
      message: 'Prefer Apple Maps? Redirect any Google Maps URL to open in Apple Maps.',
      description:
        'Use case description for a redirection rules of opening Apple Maps from Google Maps links',
    }),
  },
  {
    title: translate({
  ...
  },
  {
    title: translate({
      ...
      description:
        'Use case title for a redirection rules of jumping from Fandom pages to the official Terraria or Minecraft wikis',
    }),
    description: translate({
      ...
      description:
        'Use case description for a redirection rules of jumping from Fandom pages to the official Terraria or Minecraft wikis',
    }),
  },
  {
    title: translate({
    ...
    description: translate({
      ...
      message:
        'Open Figma, Notion, or Google Meet links directly in their desktop apps on your Mac.',
      description:
        'Use case description for a redirection rules of opening links in their native apps',
    }),
  },
    ...
    <section className={styles.useCases}>
      ...
      <div className="text--center margin-bottom--lg">
        <p>
          <b>
            ⭐️
            <Translate id="general.protipLabel" description="Label for a hint">
              Protip
            </Translate>
          </b>
          :{' '}
